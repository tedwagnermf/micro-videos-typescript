...
describe("Category Integration tests", () => {
  describe("create method", () => {
    it("should be invalid category using name property", () => {
    ...
    it("should be invalid category using description property", () => {
      expect(
    ...
    it("should be invalid category using is_active", () => {
  ...
  describe("update method", () => {
    it("should be invalid when updating a category using name property", () => {
